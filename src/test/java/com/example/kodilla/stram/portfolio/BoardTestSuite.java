package com.example.kodilla.stram.portfolio;

import com.example.kodilla.stream.portfolio.Board;
import com.example.kodilla.stream.portfolio.Task;
import com.example.kodilla.stream.portfolio.TaskList;
import com.example.kodilla.stream.portfolio.User;
...
public class BoardTestSuite {
    public Board prepareTestData() {
        //users
        User user1 = new User("developer1", "ania ania");
        User user2 = new User("projectmanager1", "asia basia");
        User user3 = new User("developer2", "kuba kuba");
        User user4 = new User("developer3", "jacek placek");
        //tasks
